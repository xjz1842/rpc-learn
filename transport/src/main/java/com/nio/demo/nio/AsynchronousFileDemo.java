...
public class AsynchronousFileDemo {
    ...
    public void testCompletionHandler() throws IOException, InterruptedException {
        ...
        AsynchronousFileChannel ch = AsynchronousFileChannel.open(Paths.get("/Users/zxj/github/rpc-learn/transport/src/main/resources/target.txt"), StandardOpenOption.READ);
        //读取文件临时ByteBuffer对象
